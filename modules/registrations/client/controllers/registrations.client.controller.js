(function () {
  ...
  RegistrationsController.$inject = ['$scope', '$state', '$window', 'Authentication', 'registrationResolve'];

  function RegistrationsController ($scope, $state, $window, Authentication, registration) {
    var vm = this;
